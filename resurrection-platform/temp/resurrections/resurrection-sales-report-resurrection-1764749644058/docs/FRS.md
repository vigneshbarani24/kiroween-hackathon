...
**Resurrection ID:** 9b50d4eb-f106-447d-b7f2-2b6bb1ade4f6
...
1. **Select sales orders of type 'OR'**
   - Status: ✅ Preserved
   - Implementation: CAP service handler

2. **Distinguish between high value and standard orders based on net value**
   - Status: ✅ Preserved
   - Implementation: CAP service handler
