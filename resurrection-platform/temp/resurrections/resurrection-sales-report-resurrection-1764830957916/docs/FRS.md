...
**Resurrection ID:** 61c931d0-569b-486a-9241-32e7dba0a051
...
- VBAK for sales order header data
- VBAP for sales order item data (implied by context but not directly used)
...
2. **Categorize sales orders based on net value**
   - Status: ✅ Preserved
   - Implementation: CAP service handler
