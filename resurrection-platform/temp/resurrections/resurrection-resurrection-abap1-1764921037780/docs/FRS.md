...
**Resurrection ID:** 590b32a5-4564-412b-82c7-fb72387bfab0
...
1. **Calculate open quantities for purchase orders**
   - Status: ✅ Preserved
   - Implementation: CAP service handler

2. **Display a report of open purchase orders with various details such as PO Number, Vendor, Plant, Material, PO Qty, GR Qty, Open Qty, and Net Price**
   - Status: ✅ Preserved
   - Implementation: CAP service handler
